...
const itemToStoreFromScrapedItem = (storedItem, scrapedItem) => {
    ...
    Object.keys(scrapedItem).forEach(propertyKey => {
        ...
        itemToStore[propertyKey] = scrapedItem[propertyKey] && scrapedItem[propertyKey].length > 0
            ? scrapedItem[propertyKey] : itemToStore[propertyKey];
    });
    ...
    Object.keys(scrapedItem).forEach(propertyKey => {
        ...
        providerItemToStore[propertyKey] = scrapedItem[propertyKey] && scrapedItem[propertyKey].length > 0
            ? scrapedItem[propertyKey] : providerItemToStore[propertyKey];
    });
